...
# Del 1 - Få din ESP32 til at blinke den røde LED med 1 seconds interval
...
while True: # starter uendelig while løkke
    ...
    # kalder sleep funktionen med argumentet 1
    # (som laver et delay i programmet på 1 sekund)
    sleep(1) 
